FROM ghcr.io/martinyuhk/my_openclaw_rl:v1.0.0

ENV TORCH_CUDA_ARCH_LIST="8.0"

RUN MAX_JOBS=2 FLASH_ATTN_CUDA_ARCHS="80" /my_workspace/.venv/bin/pip install --no-build-isolation -v flash-attn==2.7.4.post1
